...
async function initialLoad() {
  try {
    ...
    // Call the handleBreedSelection function immediately after loading breeds
...
async function handleBreedSelection() {
  try {
    ...
    // Other logic for information section
  } catch (error) {
...
axios.interceptors.request.use(function (config) {
  ...
  // Add a request interceptor with onDownloadProgress option
  axios.interceptors.request.use(function (config) {
